...
test("MessageList falls back to message.content when parts have no text", () => {
  const messages: Message[] = [
    {
      id: "1",
      role: "assistant",
      content: "Here is the component I built for you.",
      parts: [
        {
          type: "tool-invocation",
          toolInvocation: {
  ...
  expect(screen.getByText("Creating /App.jsx")).toBeDefined();
  expect(screen.getByText("Here is the component I built for you.")).toBeDefined();
});
